...
void LoadSettingsFromEeprom()
{
  ...
  LoadSane(globalSettings.vfoA.frequency,EEPROM_ADDR_VFO_A_FREQ,400000UL+1,109000000UL-1);//Allow all freq supported by si5351 driver --Tom changed to 400000 instead of 500000
  LoadSane(globalSettings.vfoB.frequency,EEPROM_ADDR_VFO_B_FREQ,400000UL+1,109000000UL-1);//Allow all freq supported by si5351 driver --TOM changed to 400000 instead of 500000
